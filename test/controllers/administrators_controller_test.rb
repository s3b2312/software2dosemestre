...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { correo: @administrator.correo, direccion: @administrator.direccion, horario: @administrator.horario, nombre: @administrator.nombre, numero_contacto: @administrator.numero_contacto, rut: @administrator.rut } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { correo: @administrator.correo, direccion: @administrator.direccion, horario: @administrator.horario, nombre: @administrator.nombre, numero_contacto: @administrator.numero_contacto, rut: @administrator.rut } }
