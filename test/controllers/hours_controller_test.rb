...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { identificador: @hour.identificador, tiempo_ini: @hour.tiempo_ini, tiempo_ter: @hour.tiempo_ter } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { identificador: @hour.identificador, tiempo_ini: @hour.tiempo_ini, tiempo_ter: @hour.tiempo_ter } }
